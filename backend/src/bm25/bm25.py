...
import mmh3
import numpy as np
from bm25.utils import (
    define_cache_dir,
    iter_batch,
    get_all_punctuation,
    remove_non_alphanumeric,
)
from bm25.parallel_processor import ParallelWorkerPool, Worker
from bm25.sparse_embedding_base import (
    SparseEmbedding,
    SparseTextEmbeddingBase,
)
from bm25.tokenizer import VietnameseTokenizer
from bm25.model_description import SparseModelDescription, ModelSource
...
supported_bm25_models: list[SparseModelDescription] = [
    SparseModelDescription(
        ...
        license="apache-2.0",
        size_in_GB=0.01,
        sources=ModelSource(hf="davicn81/bm25"),
